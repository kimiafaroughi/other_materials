...
renderPlotly(
  nyc_airbnb |> 
    filter(
      ...
      price <= input[["price_choice"]][2], #pulling out the larger input (max)
      price >= input[["price_choice"]][1], #pulling out the smaller input (min)
